...
public class ConstantQuery {
	...
	public static final String LOAD_ALL_CONFIGS_BY_STATUS = "SELECT * FROM CONFIG WHERE status like ?";
	public static final String LOAD_CONFIG_BY_STATUS = "SELECT * FROM CONFIG WHERE status like ? limit 1";
